...
public class Path2019 {
	...
	private static final double RIGHT_ROCKET_CLOSE_ANGLE = -LEFT_ROCKET_CLOSE_ANGLE;
	private static final double LEFT_ROCKET_REAR_ANGLE = 180 - LEFT_ROCKET_CLOSE_ANGLE;
	private static final double RIGHT_ROCKET_REAR_ANGLE = -LEFT_ROCKET_REAR_ANGLE;
